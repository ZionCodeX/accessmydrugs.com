                ...
                <div class="row">
                    <div class="col-12">
                        <div class="call_action_inner">
                            <div class="call_text">
                                <h4>Want us to supply your Drug Refills?</b></h4>
                ...
                <div class="row">
                        ...
                        <div class="widgets_container widget_menu">
                            ...
                            <div class="footer_menu">
                                <ul>
                                    ...
                                    <!--<li><a href="/wealth-club">Wealth Club</a></li>-->
                                    <li><a href="/faq">FAQs</a></li>
                                    <li><a href="https://blog.accessmydrugs.com" target='_blanc'>Blog</a></li>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="widgets_container widget_menu">
                            ...
                            <div class="footer_menu">
                                <ul>
                                    <li><a href="#">Drug Refills</a></li>
                                    <li><a href="#">Drug Returns</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright_area">
                            <p>Copyright &copy; 2023 <a href="#"><b>Access My Drugs Limited.</b></a> All Right Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <!-- <a href="#"><img src="../../assets/img/icon/payment.png?a=5" alt=""></a> -->
                            <a href="#"><img src="../../assets/img/icon/paystack.png?k=7" alt="" width="200"></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- modal area end--><?php /**PATH C:\xampp\htdocs\accessmydrugs.com\resources\views/components/inc_footer_content_shop.blade.php ENDPATH**/ ?>