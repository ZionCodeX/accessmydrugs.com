                                    ...
                                    <li class="top_links">
                                        ...
                                        <a href="#">
                                            <i class="ion-android-person"></i> 
                                                <?php if(Auth::check()): ?>
                                                     Hi <b><?php echo e(Auth::user()->first_name ?? ''); ?></b>
                                                <?php else: ?>
                                                    My Account
                                                <?php endif; ?>
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="middel_right">
                            <div class="search-container search_two">
                                <form method="post" action="<?php echo e(route('shop_search')); ?>"  enctype="multipart/form-data">
                                     <?php echo csrf_field(); ?>
    ...
    <!--header area end--><?php /**PATH C:\xampp\htdocs\accessmydrugs.com\resources\views/components/inc_header_top_section_shop.blade.php ENDPATH**/ ?>