<?php $__env->startSection('title', "Search | $search_key" ); ?>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="shop_title">
                        <h1>Search Result for <?php echo e($search_key ?? ""); ?></h1>
                    </div>
                    ...
                    <?php $__currentLoopData = $products_search; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="single_product">
                                ...
                                <div class="product_thumb">
                                    ...
                                    <div class="label_product">
                                        <span class="label_sale"><?php echo e($product->product_quantity); ?> in stock</span>
                                    </div>
                                ...
                                <div class="product_content list_content">
                                    <div class="left_caption">
                                        <div class="product_name">
                                            <h3><a href="<?php echo e(route('shop_product_details_view_index', ['product_slug' => $product->product_slug, 'product_category' => $product->product_category, 'pid_product' => $product->pid_product])); ?>" class='shorten_text'><?php echo $product->product_description; ?></a></h3>
                                        </div>
                                        <div class="product_ratings">
                                            <ul>
                                                <li><a href="#"><i class="ion-star"></i></a></li>
                                    ...
                                    <div class="right_caption">
                                        <div class="text_available">
                                            <p>Availabe: <span><?php echo e($product->product_quantity); ?> in stock</span></p>
                                        </div>
                                        <div class="price_box">
                                            <span class="current_price">₦<?php echo e(number_format($product->product_price)); ?></span>
                                        ...
                                        <div class="cart_links_btn">
                                            <a href="<?php echo e(route('shop_product_details_view_index', ['product_slug' => $product->product_slug, 'product_category' => $product->product_category, 'pid_product' => $product->pid_product])); ?>" title="add to cart">View | Buy</a>
                                        </div>
...
<?php echo $__env->make('layouts.base_shop', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\accessmydrugs.com\resources\views/pages/shop_search.blade.php ENDPATH**/ ?>