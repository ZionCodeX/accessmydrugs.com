...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<!--begin::Header Mobile-->
		@include('components/inc_nav_header_mobile')
		<!--end::Header Mobile-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
              ...
              @show
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<!--begin::Header-->
					@include('components/inc_nav_header')
					<!--end::Header-->
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">ADMIN-ID</h5>
									<!--end::Page Title-->
									<!--begin::Actions-->
									<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
									<span class="text-muted font-weight-bold mr-4">{{ Str::upper(auth()->user()->pid_admin) }}</span>
								...
								<div class="d-flex align-items-center">
									...
									<!--end::Daterange-->
									<!--begin::Dropdowns-->
									<a href="{{ url()->previous() }}" class="btn btn-light-primary font-weight-bolder btn-sm"><i class="fas fa-backspace"></i>Back</a>
									<!--end::Dropdowns-->
								</div>
								<!--end::Toolbar-->
							</div>
		...
		<!-- begin::User Panel-->
			  @include('components/inc_user_panel')
		<!-- end::User Panel-->
