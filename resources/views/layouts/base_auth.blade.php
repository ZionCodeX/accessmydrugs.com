          ...
          >
                <div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
                  <span class="mr-1">2023 ©</span>
                      <a
                        href="https://www.accessmydrugs.com"
                        target="_blank"
                        class="text-dark-75 text-hover-primary"
                        >AccessMyDrugs Limited</a
                      >
                </div>
                <a href="https://www.accessmydrugs.com/terms" class="text-primary font-weight-bolder font-size-lg"
                  >Terms & Conditions</a
                >
          </div>
      <!--end::Content footer-->
		...
		<script>var HOST_URL = "https://accessmydrugs.com";</script>
