            ...
            <div class="checkout_form">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <form method="post" action="{{ route('paystack_payment_processing'); }}"  enctype="multipart/form-data">
                            @csrf
                        ...
                        <!--<form action="#">-->
                            ...
                            <div class="order_table table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td> {{ $product_name }} <strong> × {{ $purchase_quantity }}</strong></td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="order_total">
                                            <th>Order Total</th>
                                            <td><strong>₦{{ number_format($total_cost) }}</strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <div class="payment_method">
                                ...
                                <input type='hidden' name='pid_product' value='{{ $pid_product }}' />
                                <input type='hidden' name='product_quantity' value='{{ $purchase_quantity }}' />
